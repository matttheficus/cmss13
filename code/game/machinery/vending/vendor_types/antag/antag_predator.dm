...
GLOBAL_LIST_INIT(cm_vending_blooded_thrall, list(
		list("Essential Blooded Equipment", 0, null, null, null),
		list("Blooded Equipment", 0, list(/obj/item/device/thrall_teleporter, /obj/item/storage/medicomp/full, /obj/item/device/radio/headset/yautja), MARINE_CAN_BUY_KIT, VENDOR_ITEM_REGULAR),
